...
/**
 * Generates simplex noise in 3D space.
 *
 * @param {number} xin - The x-coordinate input.
 * @param {number} yin - The y-coordinate input.
 * @param {number} zin - The z-coordinate input.
...
simplex3.docs = {
    header: 'simplex3(xin, yin, zin',
    body: 'Generates simple noise in 3D space.',
}
